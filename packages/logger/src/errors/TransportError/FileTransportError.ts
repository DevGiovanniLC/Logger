...
export function directorySetupFailed(boundary: Function | Object, targetDir: string, cause: unknown): never {
    return errorThrower(
        boundary,
        new FileTransportError(
...
export function fileWriteFailed(boundary: Function | Object, filePath: string, cause: unknown): never {
    return errorThrower(
        boundary,
        new FileTransportError(
